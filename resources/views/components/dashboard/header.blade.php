<header
    class="fixed top-0 right-0 left-0 z-30 bg-white border-b border-gray-200 dark:bg-neutral-900 dark:border-neutral-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <!-- Horloge -->
                <div id="clock" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                    --:--:--
                </div>
                <script>
