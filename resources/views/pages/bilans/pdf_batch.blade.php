...
<head>
    ...
    <style>
        ...
        /* STYLE IDENTIQUE A TON TEMPLATE */
        ...
        .footer { position: relative; margin-top: 30px; width: 100%; text-align: center; font-size: 7px; border-top: 1px solid #ccc; padding-top: 5px; }
    </style>
</head>
<body>
    ...
    <div class="page-container">
        ...
        <div class="signature-section">
            <div class="signature-box">
                <p class="bold underline uppercase">Le Surveillant Général</p>
            </div>
            <div class="signature-box">
                <p class="bold uppercase">Résultat:</p>
                <div class="decision-box">{{ $moyFinale >= 10 ? 'ADMIS(E)' : 'ÉCHEC' }}</div>
            </div>
            <div class="signature-box">
                <p class="bold underline uppercase">Le Directeur</p>
