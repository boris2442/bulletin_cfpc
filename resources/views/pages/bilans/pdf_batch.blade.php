...
<head>
    <meta charset="utf-8">
    <title>Impression Groupée - Relevés de Notes</title>
    <style>
        ...
        .footer { position: absolute; bottom: 20px; width: 100%; text-align: center; font-size: 7px; border-top: 1px solid #ccc; padding-top: 5px; }
        ...
        <table class="notes-table">
            <thead>
                <tr class="bg-gray">
                    ...
                    <th width="30">Sem.</th>
                    <th width="30">Coef</th>
                    <th width="50">Note/20</th>
                    <th width="60">Points</th>
                </tr>
            </thead>
            <tbody>
                @php $ptsS1 = 0; $coefS1 = 0; @endphp
                <tr class="bg-gray"><td colspan="5" class="bold">SEMESTRE 1</td></tr>
                ...
                <tr class="bg-blue bold">
                    <td colspan="2" align="right">TOTAL & MOYENNE S1 :</td>
                ...
                <tr class="bg-gray"><td colspan="5" class="bold">SEMESTRE 2</td></tr>
                ...
                @endforeach
                <tr class="bg-blue bold">
                    <td colspan="2" align="right">TOTAL & MOYENNE S2 :</td>
            ...
            <div style="width: 45%; float: left;">
                <div style="border: 2px solid #000; padding: 5px; background-color: #f9f9f9; margin-bottom: 5px;">
                    <table width="100%" style="border: none; font-size: 8px;">
                        <tr><td style="border: none;">TOTAL MODULES :</td><td align="right" class="bold">{{ $totalModules }}</td></tr>
                        <tr><td style="border: none; color: green;">VALIDÉS :</td><td align="right" class="bold" style="color: green;">{{ $modulesValides }}</td></tr>
                        <tr><td style="border: none; {{ $modulesEchoues > 0 ? 'color: red;' : '' }}">ÉCHOUÉS :</td><td align="right" class="bold" style="{{ $modulesEchoues > 0 ? 'color: red;' : '' }}">{{ $modulesEchoues }}</td></tr>
                    </table>
                </div>
                <div style="border: 1px solid #ccc; padding: 5px; font-style: italic; font-size: 7px;">
                    ...
                    16-20: TB | 14-15.99: B | 12-13.99: AB | 10-11.99: P | < 10: F
                </div>
            </div>

            <table class="recap-table" style="width: 50%; float: right;">
                <tr><td class="bg-gray uppercase" style="font-size: 8px;">Moy. Évaluations (30%)</td><td class="text-center">{{ $totalCoefsGénéral > 0 ? number_format($totalPointsGénéral / $totalCoefsGénéral, 2) : '0.00' }}</td></tr>
                <tr><td class="bg-gray uppercase" style="font-size: 8px;">Examen Bilan (70%)</td><td class="text-center">{{ number_format($evalBilan->note ?? 0, 2) }}</td></tr>
                <tr style="background-color: #f4cccc;"><td class="uppercase" style="font-size: 9px;">Moyenne Générale / 20</td><td class="text-center" style="font-size: 14px; font-weight: 900;">{{ number_format($moyFinale, 2) }}</td></tr>
            </table>
