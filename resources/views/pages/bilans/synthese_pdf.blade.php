    ...
    <table class="header-table">
        <tr>
            ...
            <td width="30%" align="center" style="vertical-align: middle;">
                ...
                <img src="{{ public_path('images/logo2.png') }}" style="width: 80px; height: auto;">
            </td>
    ...
    <div class="info-section">
        <table class="info-grid">
            <tr>
                ...
                <td width="35%">{{ $anneeActive->date_debut->format('Y') }} -
                    {{ $anneeActive->date_fin->format('Y') }}</td>
    ...
    <table class="results">
        <thead>
            <tr class="bg-green">
                ...
                <th rowspan="2" width="50" style="background-color: #fce5cd; color: #b91c1c;">MOY.GEN. (100%)
                </th>
            </tr>
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 8px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000; padding: 3px; font-weight: bold; color: green;">
                        {{ $stats['admis'] }}</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 3px;">Nombre d'Échecs</td>
                    <td style="border: 1px solid #000; padding: 3px; font-weight: bold; color: red;">
                        {{ $stats['echoues'] }}</td>
                </tr>
                <tr>
                ...
                <tr style="background-color: #f9f9f9;">
                    ...
                    <td style="border: 1px solid #000; padding: 3px; font-weight: bold;">
                        {{ number_format($stats['moyenne_classe'], 2) }} / 20</td>
                </tr>
            </tbody>
        </table>
    </div>
