...
@section('content')
<div class="bg-gray-100 p-4 mb-4 text-xs font-mono dark:bg-neutral-900 dark:text-gray-400 ml-64">
    DEBUG : <br>
    - Classe sélectionnée ID : {{ request('classe_id') ?? 'Aucune' }} <br>
    - Année Active ID : {{ $anneeActive->id }} <br>
    - Nombre d'étudiants trouvés : {{ $etudiants->count() }} <br>
    - Module Bilan trouvé : {{ $moduleBilan ? $moduleBilan->nom_module : 'NON CONFIGURÉ (is_bilan = 0 partout)' }}
</div>
