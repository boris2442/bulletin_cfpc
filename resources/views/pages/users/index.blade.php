    ...
    <form action="{{ route('users.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
        ...
        <div class="md:w-64">
            <select name="role" onchange="this.form.submit()" 
                    class="w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl px-5 py-3.5 border border-gray-200 dark:border-gray-600 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all shadow-sm appearance-none cursor-pointer">
